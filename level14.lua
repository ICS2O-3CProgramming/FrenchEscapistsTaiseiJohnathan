...
local function SetChoices()
    if (choice1 == 1) then
        rightAnswer = "descends"
        rightAnswerDisplay.size = 70
    elseif (choice1 == 2) then
        rightAnswer = "descends(tu)"
        rightAnswerDisplay.size = 50
    elseif (choice1 == 3) then
        rightAnswer = "descend"
        rightAnswerDisplay.size = 70
    elseif (choice1 == 4) then
        rightAnswer = "descendons"
        rightAnswerDisplay.size = 50
    elseif (choice1 == 5) then
        rightAnswer = "descendez"
        rightAnswerDisplay.size = 50
    elseif (choice1 == 6) then
        rightAnswer = "descendent"
        rightAnswerDisplay.size = 50
    end

    if (choice2 == 1) then
        wrongAnswer1 = "descends"
        wrongAnswerDisplay1.size = 70
    elseif (choice2 == 2) then
        wrongAnswer1 = "descends(tu)"
        wrongAnswerDisplay1.size = 50
    elseif (choice2 == 3) then
        wrongAnswer1 = "descend"
        wrongAnswerDisplay1.size = 70
    elseif (choice2 == 4) then
        wrongAnswer1 = "descendons"
        wrongAnswerDisplay1.size = 50
    elseif (choice2 == 5) then
        wrongAnswer1 = "descendez"
        wrongAnswerDisplay1.size = 50
    elseif (choice2 == 6) then
        wrongAnswer1 = "descendent"
        wrongAnswerDisplay1.size = 50
    end

    if (choice3 == 1) then
        wrongAnswer2 = "descends"
        wrongAnswerDisplay2.size = 70
    elseif (choice3 == 2) then
        wrongAnswer2 = "descends(tu)"
        wrongAnswerDisplay2.size = 50
    elseif (choice3 == 3) then
        wrongAnswer2 = "descend"
        wrongAnswerDisplay2.size = 70
    elseif (choice3 == 4) then
        wrongAnswer2 = "descendons"
        wrongAnswerDisplay2.size = 50
    elseif (choice3 == 5) then
        wrongAnswer2 = "descendez"
        wrongAnswerDisplay2.size = 50
    elseif (choice3 == 6) then
        wrongAnswer2 = "descendent"
        wrongAnswerDisplay2.size = 50
    end
end
...
function scene:create( event )
    ...
    VerbText = display.newText("Descendre", 650, 200, "Images/vinet.otf", 40)

...
local function SetChoices()
    ...
    elseif (choice1 == 6) then
        rightAnswer = "finissent"
    end

    if (choice2 == 1) then
        wrongAnswer1 = "finis"
    elseif (choice2 == 2) then
        wrongAnswer1 = "finis(tu)"
    ...
    elseif (choice2 == 6) then
        wrongAnswer1 = "finissent"
    end

    if (choice3 == 1) then
        wrongAnswer2 = "finis"
    elseif (choice3 == 2) then
        wrongAnswer2 = "finis(tu)"
...
function RemoveListenersLevel6()
...
function scene:create( event )
    ...
    VerbText = display.newText("Finir", 650, 200, "Images/vinet.otf", 40)
